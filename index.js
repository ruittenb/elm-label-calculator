...
var _user$project$Main$getTotalLabels = function (model) {
	return A3(
		_elm_lang$core$List$foldl,
		F2(
			function (x, y) {
...
var _user$project$Main$viewTableFooter = function (model) {
	var totalLabels = _user$project$Main$getTotalLabels(model);
											...
											_0: _elm_lang$html$Html$text(
												A2(
													...
													A2(
														_elm_lang$core$Basics_ops['++'],
														' / ',
														_elm_lang$core$Basics$toString(_user$project$Main$target)))),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _user$project$Main$updateAimForTarget = F2(
	function (noUpdateDataList, toUpdateData) {
		...
		return _elm_lang$core$Native_Utils.update(
			toUpdateData,
			{
				quantity: _elm_lang$core$Basics$round(newQuantity)
			});
	});
